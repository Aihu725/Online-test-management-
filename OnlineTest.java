...
class OnlineTest extends JFrame implements ActionListener
{
	...
	void set()
	{
		...
		if(current==0)
		{
			l.setText("Que1: Which one among these is a datatype");
			jb[0].setText("int");jb[1].setText("Float");jb[2].setText("char");jb[3].setText("all of the above");	
		}
		if(current==1)
		{
			l.setText("Que2: Which component is used to compile,debug and execute the java programs?");
			jb[0].setText("JRE");jb[1].setText("JIT");jb[2].setText("JVM");jb[3].setText("JDK");
		}
		if(current==2)
		{
